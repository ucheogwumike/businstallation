...
if (isset($_GET['controller']) && $_GET['controller'] == 'pjInstaller')
{
	...
	if (in_array($_GET['action'], array('pjActionLicense', 'pjActionHash', 'pjActionCaptcha')) || strpos($_GET['action'], 'pjActionSecure') === 0)
	{
		$stop = false;
	}
}
...
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "1.1.3");
