...
<p>
	<label class="bs-content"><?php __('lblTotalBuses')?>: <?php echo count($tpl['bus_arr']);?></label>
</p>
<p>
...
<p>
	<label class="bs-content bold"><?php __('lblBuses')?></label>
</p>
<table cellpadding="0" cellspacing="0" border="0" class="table b20">
	<tbody>
		...
		foreach($tpl['bus_arr'] as $k => $v)
		{
			?>
			<tr>
				<td style="width: 150px;"><?php echo pjUtil::formatTime($v['departure_time'], "H:i:s", $tpl['option_arr']['o_time_format']);?> - <?php echo pjUtil::formatTime($v['arrival_time'], "H:i:s", $tpl['option_arr']['o_time_format']);?></td>
				<td class="center" style="width: 150px;"><?php echo $v['total_travels']; ?></td>
				<td class="center" style="width: 150px;"><?php echo $v['total_bookings']; ?></td>
				<td class="center" style="width: 150px;"><?php echo $v['total_tickets']; ?></td>
				<td class="center" style="width: 150px;"><?php echo pjUtil::formatCurrencySign(number_format($v['total_income'], 2), $tpl['option_arr']['o_currency']);?></td>
			</tr>
			<?php
		} 
		?>
...
<table cellpadding="0" cellspacing="0" border="0" class="table b20">
	<tbody>
		<tr>
			<td style="width: 150px;">&nbsp;</td>
			<td style="width: 150px;"><?php __('lblBuses')?></td>
			<td style="width: 150px;"><?php __('lblTravels')?></td>
			<td style="width: 150px;"><?php __('lblNumberBookings')?></td>
			<td style="width: 150px;"><?php __('lblNumberTickets')?></td>
			<td style="width: 150px;"><?php __('lblTotalAmount')?></td>
		...
		foreach($tpl['days'] as $k => $v)
		{
			...
			<tr>
				...
				<td class="center" style="width: 150px;"><?php echo isset($tpl['timetable_arr'][$k]['buses']) ? $tpl['timetable_arr'][$k]['buses'] : '--'; ?></td>
				...
				<td class="center" style="width: 150px;"><?php echo isset($tpl['timetable_arr'][$k]['total']) ? pjUtil::formatCurrencySign(number_format($tpl['timetable_arr'][$k]['total'], 2), $tpl['option_arr']['o_currency']) : '--'; ?></td>
			</tr>
			<?php
		} 
		?>
...
<a href="#" class="pj-button float_right bs-print-report"><?php __('btnPrint'); ?></a>
